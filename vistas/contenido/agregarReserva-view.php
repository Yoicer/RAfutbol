...
<div class="container-fluid">
    <div class="page-header">
        <h1 class="text-titles"><i class="zmdi zmdi-calendar-alt"></i> REALIZAR RESERVA</h1>
    </div>
</div>
...
<div class="container-fluid">
    <div class="panel panel-info">
        <div class="panel-heading">
            <h3 class="panel-title"><i class="zmdi zmdi-calendar-alt"></i> &nbsp; RESERVAR CANCHA</h3>
        </div>
        <div class="panel-body">
            <form action="<?php echo SERVERURL; ?>ajax/reservaAjax.php" method="post" data-form="save" class="FormularioAjax"
            autocomplete="off" enctype="multipart/form-data" >
                <fieldset>
                    <legend><i class="zmdi zmdi zmdi-calendar"></i> &nbsp;DATOS DE RESERVA</legend>
                    <div class="container-fluid">
                        <div class="row">
